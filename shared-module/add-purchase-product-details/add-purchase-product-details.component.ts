  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => AddPurchaseProductDetailsComponent),
      multi: true
    }
  ],
...
export class AddPurchaseProductDetailsComponent implements OnInit {
  ...
  SetProductData(val) {
    ...
    debugger;
    this.SNO = val.SNO;
    var LocationSelection = new Option(val.Locationname, val.LocationId.toString(), true, true);
    (<any>$('#drpLocation')).append(LocationSelection).trigger('change');

    var BinSelection = new Option(val.BinName, val.BinId.toString(), true, true);
  ...
  AddItemAndClose() {
    debugger;
if($("#dollarPrice").val()==undefined || $("#dollarPrice").val()==null || $("#dollarPrice").val()==NaN
 ||$("#dollarPrice").val()=='')
{
  $("#dollarPrice").val(0);
}
    ...
    if (this._SelecedRow.InvoiceType1 == "Import") {
      if ((+this.CUSTMTAX > 0) && (+this.SWTAX > 0)) {
        ...
        this._SelecedRow.SGSTAccountID = 0;
        this._SelecedRow.CGSTAccountID = 0;
        this._SelecedRow.type='';
        this.StockAllotment();
...
if( $("#dollarPrice").val() =='' ||  $("#dollarPrice").val()==null
 ||  $("#dollarPrice").val()==undefined || $("#dollarPrice").val()==null || $("#dollarPrice").val()>0 ){
        this._SelecedRow.dollarprice ==0
          ...
          if ((+this.lstItemsStock[i].Alloted) > 0) {
            ...
            if (this._lstSelectedItemsStock.length == 0) {
              ...
              this._lstSelectedItemsStock = [({
               ...
               ,SGSTAccountID:this._SelecedRow.SGSTAccountID
               ,CGSTAccountID:this._SelecedRow.CGSTAccountID
               ,dollarprice:this._SelecedRow.dollarprice
  ...
  LoadBinsByLocation() {
    ...
    $('#drpBin').on('select2:select', function (e) {
      ...
      if (typeof ((<any>e).params.data.id) != 'undefined') {
        ...
        that._SelecedRow.BinId = (<any>e).params.data.BinId;
        that._SelecedRow.BinName = (<any>e).params.data.binname;
  ...
  LoadLocations() {
    ...
    $('#drpLocation').on('select2:select', function (e) {
      ...
      if (typeof ((<any>e).params.data.id) != 'undefined') {
        ...
        that._SelecedRow.LocationId = (<any>e).params.data.LocationId;
        that._SelecedRow.Locationname = (<any>e).params.data.text;
        that.LoadBinsByLocation();
    ...
    this.APICall.DBCalling("ViewItemTaxes",  this._SelecedRow.ItemId,"","", this.APICall.GetCompanyID()).subscribe(
      (res: Response) => {
        ...
        if (this.lstDbResult.Table.length > 0) {
          ...
          $("#bcd").val(this.CUSTMTAX.toFixed(2));
          $("#sws").val(this.SWTAX.toFixed(2));
    ...
    $('#drpParts').on('select2:select', function (e) {
      ...
      if (typeof ((<any>e).params.data.id) != 'undefined') {
       ...
       // that.ItemId = (<any>e).params.data.id;
        ...
        that._SelecedRow.type = (<any>e).params.data.type;
