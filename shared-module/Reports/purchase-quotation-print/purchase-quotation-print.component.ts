...
@Component({
  providers: [
    { 
      ...
      useExisting: forwardRef(() => PurchaseQuotationPrintComponent),
      multi: true
    }
  ],
  selector: 'PurchaseQuotationPrint',
  templateUrl: './purchase-quotation-print.component.html',
  styleUrls: ['./purchase-quotation-print.component.css']
})
export class PurchaseQuotationPrintComponent implements OnInit {
  @Input()
  set QuotationData (val)
{
  ...
  this.lstQuotationItems=val.lstQuotationItems;
...
//   return  ((typeof(this._QuotationData)!='undefined' &&  this._QuotationData!=null) ? this._QuotationData.f: null);
