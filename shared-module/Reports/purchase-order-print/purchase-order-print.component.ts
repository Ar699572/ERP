...
@Component({
  providers: [
    { 
      ...
      useExisting: forwardRef(() => PurchaseOrderPrintComponent),
      multi: true
    }
  ],
  selector: 'PurchaseOrderPrint',
...
export class PurchaseOrderPrintComponent implements OnInit {
  ...
  set OrderData(val) {
    ...
    //this.CompanyCountryName= this.APICall.GetCompanyCountryName();
    ...
    if (val != null && typeof (val) != 'undefined') {
      ...
      try {
        ...
        this.BillToCountryName=val.BillToCountryName;
        debugger;
     ...
     //   this.TransportName1 = val.f.TransportName1.value;
        ...
        this.Vendorreference=val.f.Vendorreference.value;
...
var RecAdd = 0;
    ...
    //   Partno: "CEU00003358XXXXU",
    //   Description: "Wire Feed Package",
    //   HSN: "",
    //   Qty: "",
    //   Rate: "",
    //   Discount: "",
    ...
    //   Partno: "",
    //   Description: "Installation and commission and Transport",
    //   HSN: "",
    //   Qty: "",
    //   Rate: "",
    //   Discount: "",
